    ...
    <div className="max-w-[1200px] mx-auto space-y-6 pb-12">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          />
          <div>
            <Title level={3} style={{ margin: 0, fontWeight: 600 }} className="text-slate-800">Add New Role</Title>
            <Text className="text-sm text-slate-500">Define a new system role and its feature permissions.</Text>
          </div>
        </div>
      </div>
