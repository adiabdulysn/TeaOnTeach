        ...
        <Space direction="vertical" size={0}>
          <div className="flex items-center gap-2 mb-1">
            <Button 
                ...
                onClick={() => router.back()} 
                className="hover:bg-card-border/50 rounded-full text-text-secondary"
            />
        ...
        {fetching ? (
          ...
          >
            ...
            <div className="border-t border-card-border mt-8 pt-6 flex justify-end gap-3 px-2">
              <Button 
                onClick={() => router.back()} 
                className="h-10 px-6 rounded-lg font-medium border-card-border bg-card-bg text-text-secondary hover:text-text-primary transition-all"
              >
                Discard
              </Button>
              <Button 
                ...
                loading={loading} 
                icon={<SaveOutlined />}
                className="h-10 px-8 rounded-lg font-semibold bg-primary border-none shadow-md shadow-primary/20"
              >
                Update Ticket Type
              </Button>
            </div>
